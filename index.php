...
<html lang="en">
  ...
  <hr class="bg-danger fw-bold fixed-top" style="height: 13px; margin: top 15px;">
    ...
    <div class="container-fluid">
        <a class="navbar-brand" href="#"><img src="img/logo/logo.png" alt="" style="width:18%"></a>
    ...
    <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active" for="01">
          <img src="img/carousel/car1.jpg" class="d-block w-100" alt="" id="01">
        ...
        <div class="carousel-item" for="02">
          <img src="img/carousel/car2.jpg" class="d-block w-100" alt="..." id="02">
          <div class="carousel-caption d-none d-md-block ">
        ...
        <div class="carousel-item" for="03">
          <img src="img/carousel/car3.jpg" class="d-block w-100" alt="..." id="03">
          <div class="carousel-caption d-none d-md-block">
            <h5>Stock Sampah</h5>
        ...
        <div class="carousel-item" for="04">
          <img src="img/carousel/car4.jpg" class="d-block w-100" alt="..." id="04">
          <div class="carousel-caption d-none d-md-block">
